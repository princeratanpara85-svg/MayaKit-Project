...
export default function PixelWavePageTransition() {
    ...
    const navigate = useCallback(
        async (id: string) => {
            ...
            const img = await toPng(el, { backgroundColor: "#0a0a0a", pixelRatio: 1 });
    ...
    return (
      ...
      `}</style>
            ...
            <nav className="flex gap-6 px-8 py-5 border-b border-neutral-800 relative z-10 bg-neutral-950">
