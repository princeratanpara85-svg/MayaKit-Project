...
export function DiagonalSlidePageTransition() {
      ...
      <AnimatePresence>
        {isAnimating && transitionPage && next && (
          <div className="absolute inset-0 z-50 pointer-events-none flex items-center justify-center overflow-hidden">
            ...
            {/* Top-Left Triangle Sliding In */}
            <motion.div
              initial={{ x: "-100%", y: "-100%" }}
              animate={{ x: ["-100%", "0%", "0%", "100%"], y: ["-100%", "0%", "0%", "100%"] }}
              transition={{ duration: 1.6, ease: "easeInOut", times: [0, 0.4, 0.6, 1] }}
              className="absolute inset-0 bg-[#FFFE15]"
              style={{ clipPath: "polygon(0 0, 101% 0, 0 101%)" }}
            />
            
            {/* Bottom-Right Triangle Sliding In */}
            <motion.div
              initial={{ x: "100%", y: "100%" }}
              animate={{ x: ["100%", "0%", "0%", "-100%"], y: ["100%", "0%", "0%", "-100%"] }}
              transition={{ duration: 1.6, ease: "easeInOut", times: [0, 0.4, 0.6, 1] }}
            ...
            <motion.div
              ...
              transition={{ duration: 1.6, ease: "easeInOut", times: [0, 0.35, 0.45, 0.55, 0.65] }}
