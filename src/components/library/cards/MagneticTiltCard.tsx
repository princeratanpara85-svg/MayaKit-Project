  ...
  return (
    <div className={cn("relative w-full h-full flex items-center justify-center bg-[#0a0a12] overflow-hidden p-6", className)}>
      ...
      >
        ...
        <motion.div className="absolute inset-0 opacity-60 mix-blend-screen" style={{ background: useTransform([sx, sy], ([x, y]: any) => `radial-gradient(circle at ${x} ${y}, rgba(255,255,255,0.6), transparent 50%)`) }} />
